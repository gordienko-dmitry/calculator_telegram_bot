...
CALC_TEXT_2_word = 'Введите следующую строчку, чтобы посчитать'
CALC_TEXT_RESULT = '= {}\n'

FULL_MOON = 'Введите дату, после которой я скажу ближайшее полнолуние (год-месяц-дата):'
FULL_MOON_2 = 'Следующее полнолуние будет {}'
